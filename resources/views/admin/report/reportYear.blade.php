...
<div class="container">
    <a href="{{route('detail.orderYear')}}" class="btn btn-primary">Last Year</a>
...
<div class="container">
    <table class="table">
        ...
        <thead>
        <tr>
            <th scope="col">AVG Price Months</th>
            <th>$ {{number_format(($sumOrder[0]->total - $sumCancel[0]->sum) / 12)}}</th>
        </tr>
        </thead>
        <thead>
        <tr>
