...
@section('content')
    ...
    <div class="container">
        ...
        <div class="container">
            <form enctype="multipart/form-data" method="post" action="{{route('singers.store')}}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="age" class="form-control" placeholder="Age" aria-describedby="emailHelp" required>
